...
export const PodcastIcon: React.FC = () => <span role="img" aria-label="Podcast icon" className="text-xl">🎙️</span>;
...
export const QAIcon: React.FC = () => <span role="img" aria-label="Question Answer icon" className="text-xl">❓</span>;
